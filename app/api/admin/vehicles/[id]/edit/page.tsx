    ...
    async function loadVehicle() {
      ...
      try {
        ...
        setForm({
          ...
          inspection_expiry: toDateInput(vehicle.inspection_expiry),
          next_service_mileage: vehicle.next_service_mileage
            ? String(vehicle.next_service_mileage)
            : "",
      ...
      <div className="flex min-h-screen">
        ...
        <section className="flex-1">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-[#6b6257]">
                  Update fleet vehicle information, rates, service details, status, and the booking photo.
                </p>
              </div>
          ...
          <div className="space-y-6 p-5 md:p-8">
                ...
                <div className="relative flex min-h-[230px] items-center px-8 py-8 md:px-10">
                  <div className="max-w-2xl">
                    ...
                    <h2 className="mt-4 text-3xl font-black uppercase leading-tight text-white md:text-4xl">
                      Edit Fleet Vehicle.
                      <br />
                      Update the Rental Photo.
                    </h2>

                    <div className="mt-6 h-1 w-16 bg-[#d4af37]" />

                    <p className="mt-6 font-serif text-xl text-[#d4af37]">
                      Keep vehicle details and photos updated so staff always book the correct car.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {pageLoading ? (
              <section className="rounded-3xl border border-[#e7e2d9] bg-white p-10 text-center text-sm font-bold text-[#7a7168] shadow-xl shadow-black/5">
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-5">
                        ...
                        {form.vehicle_photo && (
                          <button
                            type="button"
                            onClick={() => updateField("vehicle_photo", "")}
                            className="mt-3 w-full rounded-xl border border-red-200 bg-red-50 px-6 py-4 text-sm font-black text-red-700 transition hover:bg-red-100"
                          >
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-[#7a7168]">
                      Save changes to update this vehicle profile, rate information, mileage, status, and photo.
                    </p>
                  </div>
