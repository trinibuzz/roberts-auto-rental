    ...
    async function loadCustomer() {
      ...
      try {
        ...
        setForm({
          ...
          license_expiry: toDateInput(customer.license_expiry),
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-[#6b6257]">
                  Update customer details, upload or replace the customer DP, and
                  save the profile.
                </p>
              </div>
                ...
                <div className="relative flex min-h-[230px] items-center px-8 py-8 md:px-10">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-6 font-serif text-xl text-[#d4af37]">
                      Upload the photo now, then save the customer.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <section className="grid gap-6 xl:grid-cols-[1fr_380px]">
                  <div className="space-y-6">
                    <FormSection
                      ...
                      subtitle="Edit contact information used for bookings and communication."
                    >
                    ...
                    <section className="sticky top-6 overflow-hidden rounded-3xl border border-[#e7e2d9] bg-white shadow-xl shadow-black/5">
                      <div className="border-b border-[#eee9df] px-6 py-5">
                        ...
                        <p className="mt-2 text-sm text-[#7a7168]">
                          Upload or replace this customer photo.
                        </p>
                      </div>
                      ...
                      <div className="p-6">
                        ...
                        {form.customer_photo && (
                          <button
                            type="button"
                            onClick={() => updateField("customer_photo", "")}
                        ...
                        <div className="mt-5 rounded-2xl border border-[#e7e2d9] bg-[#fff9e8] p-5">
                          ...
                          <p className="mt-2 text-sm leading-6 text-[#6b6257]">
                            After uploading or replacing the photo, click Save
                  ...
                  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-[#7a7168]">
                        Save changes to update the customer profile.
                      </p>
                    </div>
