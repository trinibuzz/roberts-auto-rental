        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <Link href="/rep/dashboard" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-white/50">Rep Payments</p>
            </div>
          </Link>
      ...
      <section className="mx-auto max-w-7xl px-5 py-8">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#0b1f3a] to-[#26070a] p-6 shadow-2xl md:p-10">
          ...
          <p className="mt-4 max-w-2xl text-white/70">
            Select a booking to record deposits, balances, cash payments, bank
            transfers, or card payments from the tablet.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-5">
          {bookings.length === 0 ? (
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              <h2 className="text-2xl font-black">No active bookings found</h2>
              <p className="mt-2 text-white/60">
                Confirmed or active bookings will appear here.
              </p>
            </div>
          ) : (
            bookings.map((booking) => (
              ...
              >
                <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                  <div>
                    <div className="mb-3 inline-block rounded-full bg-[#d4af37] px-3 py-1 text-xs font-black uppercase text-[#07111f]">
                      {booking.status}
                    </div>
                  ...
                  <div className="grid gap-2 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/70 sm:grid-cols-3">
                    <p>
                    ...
                    <p>
                      <span className="block text-white/40">Paid</span>
                    ...
                    <p>
                      <span className="block text-white/40">Balance</span>
